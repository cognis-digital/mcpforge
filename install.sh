#!/usr/bin/env sh
# Universal installer for mcpforge. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/mcpforge.git"
echo "Installing mcpforge ..."
