"""Native cognis-connect emit for mcpforge — forward findings to any platform.

Maps mcpforge's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    mcpforge ... --format json | mcpforge-emit --to stix
    mcpforge-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
