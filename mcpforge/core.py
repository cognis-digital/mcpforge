"""MCPFORGE core — Scaffold, test, and publish MCP servers in minutes."""
...
RULES = [
    ("MCP-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("MCP-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("MCP-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
